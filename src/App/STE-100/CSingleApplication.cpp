...
////////////////////////////////////////////////////////////////////////////////
void CSingleApplication::_newLocalConnection() {
...
////////////////////////////////////////////////////////////////////////////////
void CSingleApplication::_initLocalConnection() {
    _isRunning = false;
...
// 创建LocalServer
////////////////////////////////////////////////////////////////////////////////
void CSingleApplication::_newLocalServer() {
...
// 激活主窗口
////////////////////////////////////////////////////////////////////////////////
void CSingleApplication::_activateWindow() {
    if(w) {
        w->show();
        w->raise();
