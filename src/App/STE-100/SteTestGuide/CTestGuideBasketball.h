#ifndef CTestGuideBasketball_H
#define CTestGuideBasketball_H
#include "CTestGuideBase.h"
#include "SteDevManager/SteDevice/CDevSteVC.h"

class CTestGuideBasketball : public CTestGuideBase
{
public:
    CTestGuideBasketball();
