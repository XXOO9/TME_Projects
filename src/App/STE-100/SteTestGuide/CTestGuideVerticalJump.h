#ifndef CTestGuideVerticalJump_H
#define CTestGuideVerticalJump_H
#include "CTestGuideBase.h"
#include "SteDevManager/SteDevice/CDevSteVC.h"

class CTestGuideVerticalJump : public CTestGuideBase
{
public:
    CTestGuideVerticalJump();
...
#endif // CTestGuideVerticalJump_H
