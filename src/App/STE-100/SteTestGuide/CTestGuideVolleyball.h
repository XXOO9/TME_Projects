#ifndef CTestGuideVolleyball_H
#define CTestGuideVolleyball_H
#include "CTestGuideBase.h"
#include "SteDevManager/SteDevice/CDevSteVC.h"

class CTestGuideVolleyball : public CTestGuideBase
{
public:
    CTestGuideVolleyball();
