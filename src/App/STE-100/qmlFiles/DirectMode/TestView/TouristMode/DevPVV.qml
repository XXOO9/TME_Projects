...
Item {
    ...
    Rectangle{
        ...
        color: "#3989EE"
        radius: 30 * factor
        anchors.top: singleRectRetDisplay.bottom
        ...
        CustStuTableView{
            ...
            tableCount: 4
            widthArray: [0.25, 0.25, 0.2, 0.3, 0, 0, 0]
            headName: ["测试指标", "结果", "参考值", "结果解读", "", ""]
        }
    }
    ...
    Connections{
        ...
        onSignalCurrentTestRetAvailable:{
            ...
            if( value )
            {
                //pvvCurve.load_Point_Data(value)
                vtCurve.recvData(value);
                reStartTimeoutTimer();
            }
        }
