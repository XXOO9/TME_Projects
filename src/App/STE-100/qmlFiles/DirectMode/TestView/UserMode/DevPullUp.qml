...
Item {
    ...
    Button{
        width: rectCommitBtn.width / 2
        height: rectCommitBtn.height
        visible: InterAction.isDeveloper
        onClicked: showSignature()
        anchors.verticalCenter: rectCommitBtn.verticalCenter
        anchors.left: rectCommitBtn.right
    }
