...
Item {
    ...
    Component.onCompleted: {
        InterAction.stopElapsedTimer( "跳转到引体向上同步模式下的测试界面" )
    }
    ...
    OtmTableBackground{
        ...
        CustStuTableView{
            ...
            tableCount: 5;
            widthArray: [0.15, 0.175, 0.25, 0.25, 0.175, 0]
    ...
    Button{
        ...
        width: commitBtn.width * 0.7
        height: commitBtn.height
        anchors{ verticalCenter: commitBtn.verticalCenter; left: commitBtn.right }
    ...
    OtmConfirmPopup{
        id: confirmPopup
        anchors.centerIn: parent
        onSigCommitSuccess: turnToGroupHomePage()
    }
