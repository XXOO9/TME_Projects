...
Item{
    ...
    OtmTableBackground{
        ...
        CustStuTableView{
            ...
            anchors.bottom: parent.bottom
            anchors.bottomMargin: 30 * factor
            tableCount : GlobalProperty.isDisplayScore ? 5 : 4
            widthArray : GlobalProperty.isDisplayScore ? [0.15, 0.175, 0.25, 0.25, 0.175, 0] : [0.2, 0.2, 0.3, 0.3, 0, 0]
            headName : ["设备号", "姓名", "准考证号", "结果(次)", "成绩", ""]
