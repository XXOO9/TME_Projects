...
Item {
    ...
    Component.onCompleted: {
        InterAction.stopElapsedTimer( "跳转到跳绳同步模式下的测试界面" )
    }
    ...
    OtmTableBackground{
        ...
        CustStuTableView{
            ...
            tableCount: 6
            widthArray: [0.15, 0.175, 0.225, 0.15, 0.15, 0.15, 0]
            headName : ["设备号", "姓名", "准考证号", "结果(次)", "状态", "电量(%)"]
            cellTypeArray : [GlobalProperty.normalCell, GlobalProperty.normalCell, GlobalProperty.normalCell,
                             GlobalProperty.normalCell, GlobalProperty.testCell, GlobalProperty.normalCell, GlobalProperty.normalCell]
        }
    }
