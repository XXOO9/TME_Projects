...
Item{
    ...
    OtmTableBackground{
        ...
        CustStuTableView{
            ...
            widthArray: GlobalProperty.isDisplayScore? [0.15, 0.175, 0.2, 0.125, 0.175, 0.175] : [0.15, 0.15, 0.25, 0.25, 0.2, 0]
            headName: ["设备号", "姓名", "准考证号", "次数", "结果(ml)", "成绩"]
