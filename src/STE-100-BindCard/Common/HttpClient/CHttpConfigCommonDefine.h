...
const QString BASEIP_VALUE = "http://47.108.26.114:14005";
...
/****************************************发卡端***********************************************************/
//绑定卡号
const QString INTERRFACR_UPDATEUSERBINDCARDNUMBER_KEY    = "interface_updateUserBindCardNumber";
const QString INTERFACR_UPDATEUSERBINDCARDNUMBER_VALUE   = "/api/base/user-card";
const QString BINDCARD_KEY_UPDATEUSERNUMBER_USERID       = "userId";
const QString BINDCARD_KEY_UPDATEUSERNUMBER_CARDNO       = "cardNo";
const QString BINDCARD_KEY_UPDATEUSERNUMBER_CARDTYPE     = "cardType";

//解绑卡号
const QString INTERRFACR_DISBINDCARDNUMBER_KEY           = "interface_disBindUserCardNumber";
const QString INTERFACR_DISBINDCARDNUMBER_VALUE          = "/api/base/user-card/unbind";
const QString BINDCARD_KEY_DISBINDCARDNUMBER_USERID      = "userId";

//用户登录
const QString INTERFACE_USERLOGIN_KEY                    = "interface_userLogin";
const QString INTERFACE_USERLOGIN_VALUE                  = "/api/account/login";
const QString LOGIN_ACCOUNT_KEY                          = "username";
const QString LOGIN_PASSWD_KEY                           = "password";

//请求接口类型
enum requestType{
    UNKNOWNREQUEST = 1,            //未知类型
    GETVIDEOURLS,                  //获取指导视频链接
    SYNCUSERINFO,                  //同步用户信息
    USERIDENTIFY,                  //用户识别
    SYNCSCORESTD,                  //同步成绩标准
    HEARTBEAT,                     //心跳
    UPLOADSCORECOMMON,             //上传一般成绩(非身高体重)
    SYNCCLASSINFO,                 //班级信息同步
    TOURISTRECORD,                 //游客使用记录
    QUERYBODYELEMENTHISTORY,        //查询身高体重历史成绩
    QUERYCOMMONHISTORYSCORE,        //查询一般测试成绩
    //    TOURISTUSAGERECORD,             //游客使用记录
    UPLOADBODYELEMENT,              //上传身高体重成绩
    UPDATEUSERBINDCARDNUMBER,       //更新用户绑定的卡号
    DISBINDUSERCARDNUMBER,          //解除卡号与用户的绑定
    USERLOGIN,                      //用户登录
};
