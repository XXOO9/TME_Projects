...
void CHttpSyncUserInfo::initConfig()
{
    ...
    qDebug()<< "sync user url = " << urlString;
...
//
    ...
    for( ; iter != userArray.end(); iter++ ){
        ...
        qDebug() << "user id = " << takeValueOfKeyFromJsonObject( jsObj, USERIDENTIFY_KEY_ID ).toString();
        qDebug() << "user name = " << takeValueOfKeyFromJsonObject( jsObj, USERIDENTIFY_KEY_NAME ).toString();
        qDebug() << "card no = " << takeValueOfKeyFromJsonObject( jsObj, USERIDENTIFY_KEY_CARDNO ).toString();
        ...
        qDebug() << "url = " << takeValueOfKeyFromJsonObject( jsObj, USERIDENTIFY_KEY_AVATARURL ).toString();
